	...
	public void onReceive(Context context, Intent intent) {
        ...
        if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
        	...
        	if(!JPushBridge.ISQUIT) {
	        	...
	        	UnityPlayer.UnitySendMessage(JPushBridge.gameObjectName,JPushConfig.FUNC_RECV_MESSAGE,   msg2str(message , extras)) ;
        	} else {
            ...
            if(!JPushBridge.ISQUIT) {
		        ...
		        String extras = bundle.getString(JPushInterface.EXTRA_EXTRA);
	            UnityPlayer.UnitySendMessage(JPushBridge.gameObjectName , JPushConfig.FUNC_OPEN_NOTIFICATION ,  noti2str(title , content , extras)) ;
	        } else {
