/*
*  Setup:
*  Create an empty GameObject and add the JPushEventManager script to it.
*  Create custom event classes that extend the CustomEvent.
*
*  Restrictions & Tips:
*  DO NOT add event listeners in the Awake() method!
*  This is used by the JPushEventManager to initialize.
...
*  void Start() {
*      JPushEventManager.instance.addEventListener(CustomEventObj.EVENT_TO_LISTEN_TO, gameObject, "OnSomethingHappened");
*  }
*
...
*          JPushEventManager.instance.removeEventListener(CustomEventObj.EVENT_TO_LISTEN_TO, gameObject);
*          // remove all events
